...
File: SortedArrayDictionaryTests.cs
Version: 1.0.1
Description: This file contians NUnit test functionality for the SortedArrayDictionary Data Structure class.
...
namespace Tests.DictionaryTests {
    ...
    public class SortedArrayDictionaryTests {

        SortedArrayDictionary<int, string> Dictionary = new SortedArrayDictionary<int, string>();
